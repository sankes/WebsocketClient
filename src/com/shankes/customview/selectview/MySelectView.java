package com.shankes.customview.selectview;
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < 1000; i++) {
			if (i % 5 == 0) {
				...
				canvas.drawText(String.valueOf(i), mStartWidth - bigBound.width() / 2,
						getHeight() / 2 + bigBound.height() * 3 / 4, mPaint);
			} else {
				mPaint.setColor(lineColor);
				...
				canvas.drawText(String.valueOf(i), mStartWidth - smallBound.width() / 2,
						getHeight() / 2 + smallBound.height() * 3 / 4, mPaint);
			}
