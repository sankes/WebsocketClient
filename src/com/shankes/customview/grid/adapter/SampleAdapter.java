package com.shankes.customview.grid.adapter;
...
import com.shankes.customview.grid.util.DynamicHeightTextView;
...
public class SampleAdapter extends ArrayAdapter<String> {
	...
	public View getView(final int position, View convertView, final ViewGroup parent) {
		...
		ViewHolder vh;
		if (convertView == null) {
			convertView = mLayoutInflater.inflate(R.layout.stagger_list_item_sample, parent, false);
			vh = new ViewHolder();
