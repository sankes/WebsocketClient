package com.shankes.customview.waveview;
...
public class WaveView extends LinearLayout {
	...
	public WaveView(Context context, AttributeSet attrs) {
		...
		final TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.WaveView,
		...
		mWaveHz = attributes.getInt(R.styleable.WaveView_wave_speed, MIDDLE);
		attributes.recycle();
